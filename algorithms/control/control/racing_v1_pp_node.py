"""racing_v1_pp: frozen snapshot of pure_pursuit_node.py / racing_pp as of
2026-08-23, after the base_link TF fix, kill switch fix, AMCL recovery fix,
and margin restoration. Do not edit this file for further tuning -- copy it
forward (or edit racing_v2_pp_node.py) instead, so this version stays a
known-good reference to compare against and fall back to.
"""
...
class RacingV1PpNode(Node):
    def __init__(self):
        super().__init__('racing_v1_pp_node')
